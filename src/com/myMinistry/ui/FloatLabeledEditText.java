...
public class FloatLabeledEditText extends LinearLayout {
    ...
    private void initialize() {
        ...
        hintTextView.setTextColor(hintColor != null ? hintColor : ColorStateList.valueOf(getResources().getColor(R.color.appbasetheme_color)));
