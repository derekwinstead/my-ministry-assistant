...
public class PublicationTypeDialogFragment extends DialogFragment {
	...
	public static PublicationTypeDialogFragment newInstance(boolean _showFlow) {
		...
		args.putBoolean(AppConstants.ARG_SHOW_FLOW, _showFlow);
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		if (args != null) {
			if (args.containsKey(AppConstants.ARG_SHOW_FLOW))
				showFlow = args.getBoolean(AppConstants.ARG_SHOW_FLOW, false);
		}
		...
		if (showFlow) {
			builder.setNegativeButton(R.string.menu_no_publications, new OnClickListener() {
				...
				public void onClick(DialogInterface arg0, int arg1) {
					sListener.LiteratureTypeDialogFragmentListenerSet(AppConstants.CREATE_ID, "");
				}
			});
		}
