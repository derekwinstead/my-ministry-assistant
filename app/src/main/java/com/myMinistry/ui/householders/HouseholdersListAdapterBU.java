...
public class HouseholdersListAdapterBU extends ArrayAdapter<ItemWithDate> {
    ...
    public HouseholdersListAdapterBU(Context context) {
        super(context, 0);
    }

    public HouseholdersListAdapterBU(Context context, Cursor cursor, int leadingTextResId) {
        super(context, 0);
