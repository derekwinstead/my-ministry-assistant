...
public class HouseholdersListAdapter extends ArrayAdapter<ItemWithDate> {
    ...
    public HouseholdersListAdapter(Context context) {
        super(context, 0);
    }

    public HouseholdersListAdapter(Context context, Cursor cursor, int leadingTextResId) {
        super(context, 0);
