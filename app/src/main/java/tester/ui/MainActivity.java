...
import tester.fragments.DBBackupsFragment;
import tester.fragments.DBBackupsListFragment;
import tester.fragments.DBScheduleFragment;
import tester.fragments.EntryTypeManagerFrag;
import tester.fragments.HouseholdersFragment;
import tester.fragments.PublicationFragment;
import tester.fragments.PublicationManagerFrag;
import tester.fragments.PublishersFragment;
import tester.fragments.SummaryFragment;
import tester.fragments.TimeEditorFragment;
import tester.provider.MinistryDatabase;
import tester.util.HelpUtils;
import tester.util.PrefUtils;
import tester.util.UIUtils;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.Locale;

import static tester.util.LogUtils.LOGE;
