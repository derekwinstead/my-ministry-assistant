...
import tester.model.ItemWithDate;
...
public class TitleAndDateAdapter extends ArrayAdapter<ItemWithDate> {
    ...
    public TitleAndDateAdapter(Context context) {
        super(context, 0);
    }

    public TitleAndDateAdapter(Context context, Cursor cursor, int leadingTextResId) {
        super(context, 0);
